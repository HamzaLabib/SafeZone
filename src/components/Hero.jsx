    ...
    <section className="relative overflow-hidden border-b border-blue-500/20 bg-gradient-to-r from-[#02091f] via-[#031347] to-[#07266f]">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-8 px-4 py-10 md:grid-cols-2 md:px-8 md:py-16">
        <div className="text-white">
          ...
          <div className="mt-8 flex flex-wrap gap-4"><Link to="/register" className="rounded-xl bg-academyBlue px-8 py-3 font-semibold">Register Now</Link><Link to="/courses" className="rounded-xl border border-white/40 px-8 py-3 font-semibold">View Courses</Link></div>
